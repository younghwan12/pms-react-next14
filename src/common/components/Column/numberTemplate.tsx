...
export const numberTemplate: ColumnProps["body"] = (data: any, options: ColumnBodyOptions) => {
 ...
 * @returns
 */
export const treeNumberTemplate: ColumnProps["body"] = (data: any, options: ColumnBodyOptions) => {
    return <div className="al-r">{numberFormat(data[options.field])}</div>;
};
